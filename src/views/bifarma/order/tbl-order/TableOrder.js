    ...
    <Fragment>
      <Card>
        <CardHeader className='border-bottom'>
          <CardTitle tag='h4'>Data Order Bifarma</CardTitle>
        </CardHeader>
        <Row className='mx-0 mt-1 mb-50'>
          ...
          <Col className='d-flex align-items-center justify-content-sm-center mt-sm-0 mt-1' sm='4'>
            <Button.Ripple color='primary' tag={Link} to='/bifarma/create-order'>
              Tambah Order
            </Button.Ripple>
          </Col>
